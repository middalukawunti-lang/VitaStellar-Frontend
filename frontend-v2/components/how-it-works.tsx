      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex gap-4 mb-12">
          <button
            ...
            className={`px-6 py-3 rounded-full font-medium transition-all ${activeTab === "professionals"
          ...
          <button
            ...
            className={`px-6 py-3 rounded-full font-medium transition-all ${activeTab === "patients"
              ? "bg-[oklch(0.65_0.15_175)] text-white"
              : "bg-muted text-muted-foreground hover:bg-muted/80"
              }`}
          >
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {steps.map((step, index) => (
            <div key={step.title} className="space-y-4">
              <div className={`w-4 h-4 rounded ${colorMap[step.color]}`} />

        ...
        {isMenuOpen && (
          <div className="lg:hidden py-4 border-t border-border">
            <nav className="flex flex-col gap-4">
              ...
              <Link href="/about" className="text-muted-foreground font-medium">About Us</Link>
              <Link href="/services" className="text-muted-foreground font-medium">Services</Link>
              <Link href="/marketplace" className="text-muted-foreground font-medium">Marketplace</Link>
              <Link href="/blog" className="text-muted-foreground font-medium">Blogs</Link>
